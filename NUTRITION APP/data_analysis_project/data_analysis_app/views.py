...
def data_tab(request):
    ...
    df = pd.read_csv("C:/Users/Michelle DSouza/OneDrive/Desktop/CHRIST UNIVERSITY/2ND YEAR(3 & 4)/SEM 3/data anayltics/preprocessed_data.csv")
...
def recommend_food(request):
    if request.method == 'POST':
        ...
        file_path =  "C:/Users/Michelle DSouza/OneDrive/Desktop/CHRIST UNIVERSITY/2ND YEAR(3 & 4)/SEM 3/data anayltics/preprocessed_data.csv"
